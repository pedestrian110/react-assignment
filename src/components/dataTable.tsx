...
const DataTableComponent = () => {
    ...
    const handleChevronClick = (event: React.MouseEvent<HTMLSpanElement, MouseEvent>) => {
                    ...
                    <div className='pt-[2vh]'>
                        ...
                        >
                            <Column
                                ...
                                header={
                                    <div onClick={handleChevronClick} style={{ cursor: 'pointer' }}>
                                        <FaChevronDown style={{ color: 'yellow' }} className='text-xl' />
                                    </div>
                                }
                            />
            ...
            <OverlayPanel ref={overlayPanelRef}>
                <div className='p-3'>
                    ...
                    <input
                        type="number"
                        value={rowsToSelect}
                        onChange={(e) => setRowsToSelect(e.target.value === '0' ? '' : e.target.value)}
